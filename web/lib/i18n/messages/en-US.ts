const enUS = {
  ...
  dashboard: {
    ...
    pages: {
      ...
      topics: {
        title: "Issue Library",
        description: "Search, review, and maintain platform issue records.",
      },
      articles: {
        title: "Knowledge Base",
        description: "Review and maintain reusable solution knowledge.",
      },
      categories: {
    ...
    overview: {
      hero: {
        eyebrow: "Platform issues and knowledge",
        title: "Welcome back, {name}",
        description:
          "Track platform issues, maintain reusable solutions, and jump into issue or knowledge management.",
      ...
      pending: {
        title: "Pending work",
        description:
          "Prioritize open issues, processing issues, and knowledge reviews.",
      ...
      priority: {
        ...
        description: "Sorted by issue and review counts this account can access.",
        emptyTitle: "Nothing pending",
        emptyDescription: "No issues or reviews need attention.",
      },
      quick: {
        title: "Quick access",
        ...
        categories: "Categories and modules",
        settings: "settings",
      },
      recent: {
        title: "Recent issues",
        topics: "Recently submitted issues",
        users: "Recent users",
      },
    },
  },
  ...
  component: {
    searchInput: {
      placeholder: "Search issues and knowledge",
      searchBtn: "Search",
    },
    search: {
  ...
  pages: {
    home: {
      asideTitle: "Issue and Knowledge Base",
      asideDescription:
        "Track issues, share answers, and maintain reusable knowledge.",
    },
    nav: {
      home: "Home",
      topics: "Q&A",
    ...
    topic: {
      ...
      create: {
        ...
        issueFields: {
          ...
          issuePriority: "Priority",
          issueSeverity: "Severity",
          issueOwner: "Owner / support group",
        },
        attachment: {
    ...
    search: {
      title: "Search",
      heading: "Search issues and knowledge",
      description: "Find platform issue records and knowledge entries.",
      placeholder: "Search issues and knowledge",
      submit: "Search",
      empty: {
        ...
        promptDescription:
          "Enter a keyword to find issues and knowledge entries.",
      },
      viewMore: "View more",
      tabs: {
        all: "All",
    ...
    install: {
      title: "Install Issue and Knowledge Base",
      step: {
        welcome: "Welcome",
      ...
      welcome: {
        description:
          "Welcome to the issue and knowledge base platform. Before you start, make sure you have:",
        requirements: {
          title: "Installation Requirements",
          mysql: "MySQL (5.7+) or SQLite. MySQL is recommended for production.",
          site: "A platform name and description",
      ...
      site: {
        ...
        title: "Platform name",
        titlePlaceholder: "Enter the platform name",
        siteDescription: "Platform description",
        descriptionPlaceholder: "Enter the platform description",
        baseURL: "Platform URL",
        baseURLPlaceholder: "https://example.com",
        validationError: "Enter the platform name.",
        baseURLValidationError: "Enter the platform URL.",
      },
      admin: {
      ...
      install: {
        ...
        description: "Installing the platform. Please do not close this page.",
      },
      complete: {
        congratulations: "Congratulations, the platform has been installed.",
        description:
          "You can now enter the site or admin console to continue setup.",
        enterSite: "Open platform",
